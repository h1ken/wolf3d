...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/04 13:28:23 by cstripeb          #+#    #+#             */
/*   Updated: 2019/08/20 10:01:41 by cstripeb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list				*ft_lstsearch(t_list *lst, void *what,
...
void				ft_treeadd(t_btree **tree, t_btree *new);

void				ft_treedelone(t_btree **tree, void (*del)(void *, size_t));

void				ft_treedel(t_btree **tree, void (*del)(void *, size_t));

void				ft_treeinfix(t_btree *tree, void (*f)(t_btree *elem));

void				ft_treeprefix(t_btree *tree, void (*f)(t_btree *elem));

void				ft_treepostfix(t_btree *tree, void (*f)(t_btree *elem));
